...
const getProps = () => ({
  overallLevel: {
    ...
    name: "Good",
    description:
      "Your services are on their way but still can be better. Primarily, you should be focused on styling and maintainability now that security concerns are out of the way.",
  },
  levels: [
    { index: 0, name: "Not so great" },
    { index: 1, name: "Good" },
    { index: 3, name: "Great" },
    { index: 4, name: "Amazing" },
  ],
  scorecardCategories: [],
  levelCategories: [
...
function DynamicSidebar(props: Props): React.ReactElement {
    ...
    const scorecardCategories = [
      {
        ...
        category: { id: "13", name: "Back-End Scorecard" },
      },
      {
        level: { name: "Amazing" },
        category: { id: "99", name: "Front-End Scorecard" },
      },
