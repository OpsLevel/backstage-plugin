...
export default function ExportEntityForm() {
  ...
  const error =
    ...
    entityStates.groups.error;
  const loading =
    entityStates.components.loading ||
    entityStates.users.loading ||
    entityStates.groups.loading;
  ...
  const outputComponent = output.length ? (
  ...
  return (
    <span>
      ...
      <Typography paragraph>
        The{" "}
        <Link href="https://www.opslevel.com" target="_blank">
          OpsLevel
        </Link>{" "}
        Backstage plugin allows you to utilize OpsLevel’s powerful Service
        Maturity model within your Backstage Instance. After clicking{" "}
        <b>export</b> your Backstage Services will be populated into your
        OpsLevel account as Services. From there, you can apply{" "}
        <Link
          href="https://www.opslevel.com/docs/checks-and-filters"
          target="_blank"
        >
          Checks
        </Link>{" "}
        to your Services and begin to build your{" "}
        <Link
          href="https://www.opslevel.com/docs/getting-started-with-rubrics"
          target="_blank"
        >
          Maturity Rubric
        </Link>
      ...
      <Typography paragraph>
        Your{" "}
        <Link
          href="https://www.opslevel.com/docs/categories-and-levels#levels"
          target="_blank"
        >
          Service Levels
        </Link>{" "}
        will be reflected back into your Backstage Instance via a new{" "}
        <b>Maturity</b> tab when viewing a Component. This tab provides a full{" "}
        <Link
          href="https://www.opslevel.com/docs/maturity-report"
          target="_blank"
        >
          Maturity Report
        </Link>{" "}
        for your Backstage Services.
      </Typography>
      <Typography paragraph>
        OpsLevel’s Maturity Report will allow you to unlock valuable insights
        into the operational health of your Backstage Services as well as
        provide Service Owners the context they need to ensure they’re meeting
        their organization's best practices and standards.
      </Typography>
      <Divider />
      <form
        noValidate
